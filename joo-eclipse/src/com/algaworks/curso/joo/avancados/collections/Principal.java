...
public class Principal {
	public static void main(String[] args) {
		...
		BigDecimal gastosPrbb = governo.calcularGastosComSalario("PRBB"); // partido sem potítico no governo
		System.out.println("Gastos com partido PRBB: " + formatador.format(gastosPrbb.doubleValue()));
		
		BigDecimal gastosRblh = governo.calcularGastosComSalario("RBLH");
		System.out.println("Gastos com partido RBLH: " + formatador.format(gastosRblh.doubleValue()));
		...
		BigDecimal gastosVereadoresPcor = governo.calcularGastosComSalarioParaCargo(vereador, "PCOR");
		System.out.println("Gastos com vereadores do partido PCOR: " 
			+ formatador.format(gastosVereadoresPcor.doubleValue()));

		BigDecimal gastosDeputadosEstaduaisPcor = governo.calcularGastosComSalarioParaCargo(deputadoEstadual, "PCOR");
